 ...
 * @author p.hoeffling
 */
public class DefaultGitlabUriBuilder implements GitlabUriBuilder {
    ...
    public DefaultGitlabUriBuilder() {
        this.baseUrl = DEFAULT_URL;
        this.apiPath = DEFAULT_API_PATH;
    }

    public DefaultGitlabUriBuilder(String baseUrl) {
        this.baseUrl = baseUrl;
        this.apiPath = DEFAULT_API_PATH;
    }

    public DefaultGitlabUriBuilder(String baseUrl, String apiPath) {
        this.baseUrl = baseUrl;
